...
(This specific painitng is sound reactive (viewer needs to yell really hard and long for the full effect). The two lines changes over a longer periode of time. Viewer needs to yell long and hard for the full effect)
